...
const NewProductScreen = () => {
  ...
  return (
    <SafeAreaView style={tw`flex bg-purple-400 h-full`}>
      ...
      <View
        style={[tw`h-30 border`, { backgroundColor: "rgba(255,255,255,0.6)" }]}
      >
      ...
      <View
        style={[
          tw`flex flex-row justify-between mt-5 p-2 border`,
          { backgroundColor: "rgba(255,255,255,0.6)" },
        ]}
      >
      ...
      <View
        style={[
          tw`flex flex-row justify-between p-2 border-b border-r border-l`,
          { backgroundColor: "rgba(255,255,255,0.6)" },
        ]}
      >
        <View style={tw`flex flex-row items-center`}>
      ...
      <View style={tw`flex flex-row justify-center items-center`}>
        <TouchableOpacity style={tw`mr-5 w-20`}>
