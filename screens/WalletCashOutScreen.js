...
const WalletCashOutScreen = () => {
  ...
  return (
    <SafeAreaView style={tw`flex bg-purple-400 h-full`}>
        ...
        <View style={[tw`h-50 border mb-3`, {backgroundColor: "rgba(255,255,255,0.6)"}]}>
      ...
      <View style={[tw` border p-4 mb-3`, {backgroundColor: "rgba(255,255,255,0.6)"}]}>
        <Text>Payment</Text>
      ...
      <View style={[tw`border mb-3 flex flex-row justify-between p-3 pl-10 pr-30`, {backgroundColor: "rgba(255,255,255,0.6)"}]}>
        <Text style={tw`font-bold`}>Total cash out</Text>
        <Text style={tw`font-bold`}>RM:</Text>
      </View>      

      <TouchableOpacity style={tw`w-[40%] text-center mx-auto`} onPress={cashOutFunc}>
